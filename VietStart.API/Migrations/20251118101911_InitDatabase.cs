        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Prototype = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Comments_StartUps_StartUpId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Shares", x => new { x.UserId, x.StartUpId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Shares_StartUps_StartUpId",
                        column: x => x.StartUpId,
                        principalTable: "StartUps",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StartUpMedias", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StartUpMedias_StartUps_StartUpId",
                        column: x => x.StartUpId,
                        principalTable: "StartUps",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reacts_StartUps_StartUpId",
                        column: x => x.StartUpId,
                        principalTable: "StartUps",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shares_StartUpId",
                table: "Shares",
                column: "StartUpId");

            migrationBuilder.CreateIndex(
                name: "IX_StartUpMedias_StartUpId",
                table: "StartUpMedias",
                column: "StartUpId");
